...
let absBtn1=document.getElementById("abs-btn1")
let absBtn2=document.getElementById("abs-btn2")
let absBtn3=document.getElementById("abs-btn3")
let absBtn4=document.getElementById("abs-btn4")

let CourseName=document.getElementById("CourseName");
let ExamDate=document.getElementById("ExamDate");
let examType=document.getElementById("examType")
let markAbsenceBtn=document.getElementById("markAbsenceBtn")
let listOfSlected=[]

absBtn1.addEventListener("click",()=>{
    absBtn1.classList.toggle("numClicked")
    markAbsenceBtn.addEventListener("click",()=>{
        if (CourseName.value==="" || ExamDate.value===null || examType.value===null){
            alert("Please fill in all fields before adding a request.");
        }else{
            listOfSlected.push({student_number:absBtn1.textContent})
        }
    })
})
markAbsenceBtn.addEventListener("click",()=>{
...
// document.getElementsByClassName("abs-btn").addEventListener("click", function () {
//     console.log("clicked")
// })
...
//     document.querySelectorAll('.attendence > button.selected').forEach(button => {
//         const studentID = button.textContent.trim();
...
// document.querySelectorAll('.attendence > button').forEach(button => {
